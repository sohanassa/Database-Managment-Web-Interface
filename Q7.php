...
<body>
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q7) Viewed report of Users questionnaires of Company with ID ".$_SESSION["RegN"]."')");
