...
<body>
	...
	$tsql = "{call aloizi04.Q6SHOW_QUESTIONS_OF_QUESTIONNAIRE(?)}";  

	// Getting parameter from the http call and setting it for the SQL call
	$params = array(  
                     array($_GET["showQuestions"], SQLSRV_PARAM_IN)
					);  
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'Viewed Questions of Questionnaire with ID ".$_GET["showQuestions"]."')");
