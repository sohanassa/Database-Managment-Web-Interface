...
<body>
	...
	$params = array(  
                     ...
                     array($_GET["NOA"], SQLSRV_PARAM_IN)
					);  
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'Created new MC question with name (".$_GET["name"].") and ".$_GET["NOA"]." answers')");
