...
<body>
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q12) Viewed questionnaires with the least amount of questions of Company with ID ".$_SESSION["RegN"]."')");
