...
<body>
	...
	$tsql = "{call aloizi04.Q6DELETE_QUESTION_FROM_QUESTIONNAIRE(?,?,?)}";  

	// Getting parameter from the http call and setting it for the SQL call
	$params = array(  
					 array($_SESSION["UserID"], SQLSRV_PARAM_IN),
                     array($_GET["QuestionnaireRemove"], SQLSRV_PARAM_IN),
                     array($_GET["QuestionRemove"], SQLSRV_PARAM_IN),
					);  
    ...
    $logResult = sqlsrv_query($conn, "insert into QuestionnaireLog(QuestionnaireID, ChangeDescription, UserID) values(".$_GET["QuestionnaireRemove"].",'Removed Question with ID ".$_GET["QuestionRemove"].".',".$_SESSION["UserID"].")");
