...
<body>
	...
	$tsql = "{call aloizi04.Q15(?,?)}";  

	// Getting parameter from the http call and setting it for the SQL call
	$params = array(  
					 array($_SESSION["RegN"], SQLSRV_PARAM_IN),
					 array($_GET["number"], SQLSRV_PARAM_IN)
					);  
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q15) Viewed the ".$_GET["number"]." questions with the least appearances in questionnaires of Company with ID ".$_SESSION["RegN"]."')");
