...
<body>
	...
	$tsql = "{call aloizi04.Q17_T(?)}";
    $tsql_get = "{call aloizi04.Q17_TGET}";
    $tsql_del = "{call aloizi04.Q17_TDEL}";
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q17)')");
