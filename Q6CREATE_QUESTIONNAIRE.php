...
<body>
	...
	$tsql = "{call aloizi04.Q6CREATE_QUESTIONNAIRE(?,?)}";  

	// Getting parameter from the http call and setting it for the SQL call
	$params = array(  
					 array($_SESSION["UserID"], SQLSRV_PARAM_IN),
                     array($_GET["title"], SQLSRV_PARAM_IN)
					);  
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'Created new questionnaire with name ".$_GET["title"]."')");
