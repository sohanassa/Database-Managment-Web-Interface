...
<body>
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q11) Viewed questionnaires with more questions than the companys average (Company with ID ".$_SESSION["RegN"].")')");
