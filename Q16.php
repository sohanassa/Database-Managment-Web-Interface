...
<body>
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q16) Viewed questions that appear in all questionnaires of Company with ID ".$_SESSION["RegN"]."')");
