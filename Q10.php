...
<body>
    ...
    $logResult = sqlsrv_query($conn, "insert into Log(UserID, ActionDescription) values (".$_SESSION["UserID"].",'(Q10) Viewed average question count of questionnaires of Company with ID ".$_SESSION["RegN"]."')");
